...
<script>
import { getUserInfoDetailApi } from '@/api/user.js' // 导入 请求用户数据的二次封装方法
import loginConfirm from '@/mixins/loginConfirm.js' // 导入混入的通用方法
...
export default {
  ...
  methods: {
    ...
    async getUserInfoDetail () {
      const { data: { userInfo } } = await getUserInfoDetailApi()
